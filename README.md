...
1.	Projeto base para estudos ou fins profissionais. Feito com configurações de Docker para receber um projeto em laravel;
...
8.	Em sua máquina deverá ter o composer instalado e deverá ser configurado as variáveis de ambiente no windows; 
...
13. Em .gitignore, recomendo que "database" seja incluido por motivos de segurança. Ao criar seu banco, o exporte (caso vá para produção) e não o mantenha no código;
14. Na raiz do projeto existe um arquivo chamado exempleLaunch.json, que deve ser utilizado como base para o xdebug (.vscode/launch.json). Configure-o da forma que desejar;
15. Crie o projeto em laravel. Comando: composer create-project --prefer-dist laravel/laravel nome-do-projeto;
16. Mova os arquivos para dentro do projeto. Esse arquivo (README.md) pode ser excluido sem problemas;
17.	Para subir os containers, no terminal, digite: docker compose up -d.
